...
export default function HomePage() {
  return (
    <>
                  ...
                  {services.map((service, index) => {
                    ...
                    return (
                      <Link
                        key={service.href}
                        href={service.href}
                        className="group flex min-h-12 min-w-0 items-center gap-1.5 overflow-hidden rounded-2xl border border-white/80 bg-white/75 px-2 py-2 text-[.625rem] font-bold leading-4 tracking-[-.01em] text-slate-700 shadow-[0_12px_35px_-25px_rgba(30,90,125,.55)] backdrop-blur-xl transition-all hover:-translate-y-0.5 hover:border-sky-200 hover:bg-white hover:text-primary focus-visible:-translate-y-0.5 sm:gap-3 sm:px-3 sm:text-xs sm:tracking-normal"
                      >
                        <span
          ...
          <Reveal delay={0.15} className="relative">
            <div className="relative mx-auto max-w-[560px] lg:ml-auto">
              ...
              <div className="relative aspect-[4/4.75] overflow-hidden rounded-[2.2rem] border border-white/80 bg-white shadow-[0_40px_100px_-42px_rgba(40,105,145,.45)] sm:rounded-[2.7rem]">
                <Image
                  src="/images/hero-home-care.webp"
                  alt="Pflegefachkraft begleitet eine Seniorin sicher durch ihr helles Zuhause"
                  fill
                  priority
      ...
      <section className="relative z-10 bg-white pb-8 sm:pb-12">
        <div className="container-shell relative -mt-5 grid overflow-hidden rounded-[2rem] border border-sky-100 bg-white/95 shadow-[0_30px_80px_-40px_rgba(37,99,145,.35)] backdrop-blur-xl sm:-mt-8 sm:grid-cols-3">
          ...
          <div className="border-y border-sky-100 px-6 py-7 text-center sm:border-x sm:border-y-0 sm:py-9">
            <p className="font-editorial text-4xl font-semibold text-primary">
              Bis zu 24/7
            </p>
            <p className="mt-1 text-[.68rem] font-bold tracking-[.16em] text-muted-foreground uppercase">
          ...
          <Reveal>
            <div className="relative pb-8 pr-4">
              ...
              <div className="relative aspect-[4/4.4] overflow-hidden rounded-[2.75rem] premium-shadow">
                <Image
                  src="/images/care-consultation-hands.webp"
                  alt="Persönliches Beratungsgespräch am Tisch in ruhiger Atmosphäre"
                  fill
