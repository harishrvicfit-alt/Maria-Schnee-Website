        ...
        <div className="glass w-[min(330px,calc(100vw-40px))] rounded-3xl p-5">
          ...
          <div className="space-y-2">
            ...
            <a
              ...
              className="flex items-center gap-3 rounded-2xl bg-muted p-4 text-sm font-bold"
            >
          ...
          <p className="mt-4 text-[11px] leading-4 text-muted-foreground">
            Kein öffentlich bestätigter WhatsApp-Kanal vorhanden. Daher
            verlinken wir bewusst nur verifizierte Kontaktwege.
          </p>
        </div>
      ) : null}
      <Button
        ...
        size="lg"
        className="h-14 rounded-full px-5 shadow-xl shadow-primary/30"
        aria-label={
          open ? "Kontaktmenü schließen" : "Kontaktmöglichkeiten öffnen"
        }
        aria-expanded={open}
      >
