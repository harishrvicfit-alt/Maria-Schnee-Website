...
export function SiteFooter() {
  return (
    <footer
      id="seitenfuss"
      className="relative overflow-hidden border-t border-sky-100 bg-[linear-gradient(135deg,#f1f9fd_0%,#f8fbfd_58%,#fff3f8_100%)] text-foreground"
    >
      ...
      <div className="container-shell relative grid gap-12 py-16 md:grid-cols-2 lg:grid-cols-[1.2fr_.8fr_.9fr_1fr] lg:py-20">
        <div>
          <BrandLogo
            light
            className="mb-8 h-[128px] w-[208px] sm:h-[128px] sm:w-[208px]"
          />
          <p className="max-w-sm text-sm leading-7 text-muted-foreground">
            Ambulante und außerklinische Intensivpflege mit einem klaren Ziel:
            Sicherheit ermöglichen, Selbstbestimmung bewahren und Familien
            verlässlich entlasten.
          </p>
        </div>
        <div>
          <h2 className="mb-5 text-sm font-bold tracking-widest text-primary uppercase">
            Navigation
          </h2>
      ...
      <div className="border-t border-sky-100">
        <div className="container-shell flex flex-col gap-4 py-6 text-xs text-slate-500 sm:flex-row sm:items-center sm:justify-between">
          <p>
            © {new Date().getFullYear()} Maria Schnee GmbH. Alle Rechte
            vorbehalten.
          </p>
