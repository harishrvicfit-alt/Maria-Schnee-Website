  ...
  return (
    <footer id="seitenfuss" className="relative overflow-hidden bg-[#07111e] text-white">
      ...
      <div className="container-shell relative grid gap-12 py-16 md:grid-cols-2 lg:grid-cols-[1.2fr_.8fr_.9fr_1fr] lg:py-20">
        <div><BrandLogo light className="mb-8 h-[128px] w-[208px]" /><p className="max-w-sm text-sm leading-7 text-white/58">Ambulante und außerklinische Intensivpflege mit einem klaren Ziel: Sicherheit ermöglichen, Selbstbestimmung bewahren und Familien verlässlich entlasten.</p></div>
